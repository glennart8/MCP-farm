PRODUCTS = {
    ...
    "regel_45x120": (70, 3.0),
    "regel_45x120": (90, 3.6),
    "regel_45x120": (110, 4.2),
    "regel_45x120": (130, 4.8),
    "regel_45x145": (80, 3.0),
    "regel_45x145": (110, 3.6),
    "regel_45x145": (140, 4.2),
    "regel_45x145": (170, 4.8),
    "regel_45x170": (90, 3.0),
    "regel_45x170": (125, 3.6),
    "regel_45x170": (160, 4.2),
    "regel_45x170": (195, 4.8),
    "bräda_22x45": (25, 3.0),
    "bräda_22x70": (35, 3.6),
    "bräda_22x95": (45, 4.2),
    "bräda_22x120": (55, 4.8),
    "bräda_22x145": (65, 3.0),
    "bräda_22x145": (125, 5.2),
    "bräda_22x170": (35, 3.6),
    "bräda_22x195": (55, 4.2),
    "bräda_22x220": (75, 4.8),
    ...
    # --- SKIVMATERIAL ---
    "plywood_12mm": (250, 2.0),       # antag 2 kvm/lucka
    ...
    "råspontlucka_21x95": (65, 1.5),  # varje lucka täcker 1,5 kvm

    # --- ISOLERING ---
    "isolering_mineralull_45mm": (320, 4.0),    # 4 kvm per paket
   ...
   # --- TAK / PANEL ---
    "takpapp_rulle": (420, 20),       # 20 kvm/rulle
    "takläkt_25x38_3m": (20, None),
    "råspont_21x95_3m": (65, 1.5),    # 1,5 kvm/lucka
    ...
    "byggplast_0.2mm": (450, 50),  # 50 kvm/rulle
    "trälim_1l": (110, None),
    "spikband_1m": (30, None),
